#V 2.1.0.0
# if error, and input is true the text box clears
# Added ( ) parenthesis to calculator
...
myB17 = Button(root, text="<-", width=10, height=3, borderwidth=5, command=back)
myB17.grid(row=5, column=0)
myB18 = Button(root, text="(", width=10, height=3, borderwidth=5, command=lambda: button_click("("))
myB18.grid(row=4, column=1)
myB19 = Button(root, text=")", width=10, height=3, borderwidth=5, command=lambda: button_click(")"))
myB19.grid(row=4, column=2)
myB20 = Button(root, text=".", width=10, height=3, borderwidth=5, command=lambda: button_click("."))
myB20.grid(row=4, column=4)
myB21 = Button(root, text="//", width=10, height=3, borderwidth=5, command=lambda: button_click("//"))
myB21.grid(row=4, column=3)
myB22 = Button(root, text="CLEAR", width=23, height=3, borderwidth=5, command=clear)
myB22.grid(row=5, column=1, columnspan=2)

myB23 = Button(root, text="EQUAL", width=23, height=3, borderwidth=5, command=equal)
myB23.grid(row=5, column=3, columnspan=2)
